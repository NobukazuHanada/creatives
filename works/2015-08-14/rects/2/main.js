...
(function(exports) {
  ...
  var main = function __do() {
      ...
      if (_3 instanceof Data_Maybe.Just) {
          ...
          Graphics_Canvas.beginPath(_2)();
          Graphics_Canvas.setLineWidth(1.5)(_2)();
          ...
          Control_Monad_Eff.forE(1.0)(20.0)(function (i) {
              return function __do() {
                  var _1 = Prelude.map(Control_Monad_Eff.functorEff)(function (x) {
                      return x * 500.0 + 50.0;
                  })(Control_Monad_Eff_Random.random)();
                  var _0 = Prelude.map(Control_Monad_Eff.functorEff)(function (x_1) {
                      return x_1 * 500.0 + 50.0;
                  })(Control_Monad_Eff_Random.random)();
                  Control_Monad_Eff.foreachE(myRect(_1)(_0))(line(_2))();
                  Graphics_Canvas.stroke(_2)();
                  return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
              };
          })();
          Graphics_Canvas.closePath(_2)();
          return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
      };
      throw new Error("Failed pattern match at /Users/hanadanobukazu/creatives/purescript/first/src/Main.purs line 11, column 1 - line 30, column 1: " + [ _3.constructor.name ]);
  };
  exports["line"] = line;
